# scripts/ablation_guidance_t2i.py
...
from image_display import display_ablation_guidance_t2i
...
def main():
    ...
    # Configure logging
    with open("configs/config_guidance_t2i.yaml", "r") as config_file:
