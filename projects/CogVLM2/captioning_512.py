                    ...
                    for image_file in tqdm(
                        ...
                        if image_file.endswith(".png"):
                            ...
                            prompt_template = (
                                ...
                                f"The disaster type is {disaster_type}. Give a description in one sentence. "
...
def main():
    image_directory = "../Dataset/xBD/images-w512-h512"
    output_file = "./out/captions_512.jsonl"
    setup_logging("./log/w-512-h-512/captioning.log")
